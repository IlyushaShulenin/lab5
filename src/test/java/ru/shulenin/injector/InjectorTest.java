...
import ru.shulenin.test_classes.InterfaceImpl;
import ru.shulenin.test_classes.InterfaceTest;
import ru.shulenin.test_classes.MyClass;
...
class InjectorTest {
    ...
    public void testProp() throws IOException, ClassNotFoundException, NoSuchMethodException,
        ...
        String x = properties.getProperty("ru.shulenin.interfaces.Controller");
